...
\abstract[cs]{Práce shrnuje dosavadní poznatky v oboru biometrie při řešení problematiky identifikace osoby podle tváře. Zaměřuje se na konvoluční neuronové sítě a kapsulové sítě. Dále se zabývá současnými existujícími postupy a jejich implementacemi. V neposlední řadě nabízí vlastní implementaci obdobného řešení.}
\abstract[en]{Current findings in the field of biometrics are discussed in this thesis. Particularly their impact and evolution in face recognition. Special attention is given to convolutional neural networks and capsule networks. Thesis then lists current approaches and implementations. Later it aimps to provide insight into engineering a very own solution.}
