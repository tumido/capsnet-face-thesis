...
\subsection{Locally connected}\todo{Describe locally connected}


\subsection{Tiled convolution}\todo{Describe tiled}
...
\section{Capsule neural networks}\todo{Describe capsules}
